...
1. **The control's split half is the wrong instrument for a planted fixture** (run 1). The human decides; the coordinator recommends splitting presence from spread.
