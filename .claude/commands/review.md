---
description: "Guided human review session over completed work."
---
<!-- agent-notes: { ctx: "guided human review session", deps: [docs/methodology/personas.md, .claude/agents/cam.md], state: active, last: "claude@2026-07-07" } -->
