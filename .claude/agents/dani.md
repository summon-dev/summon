...
maxTurns: 20
---
<!-- agent-notes: { ctx: "P1 design + UX + accessibility", deps: [docs/methodology/personas.md, docs/methodology/phases.md, docs/scaffolds/design-profile.md, docs/process/done-gate.md], state: canonical, last: "claude@2026-08-09", key: ["WCAG non-negotiable", "design authority is a citation discipline: D1 profile > D2 add-on > D3 accessibility+consistency only (ADR-0013 §1)", "no unsourced aesthetic findings; House rules are human-authored"] } -->
