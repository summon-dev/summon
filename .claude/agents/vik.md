...
maxTurns: 15
---
<!-- agent-notes: { ctx: "P1 deep code review, simplicity, YAGNI, perf lens, dead code", deps: [docs/methodology/personas.md, docs/methodology/phases.md, docs/scaffolds/performance-budget.md, docs/methodology/debt-markers.md], state: canonical, last: "claude@2026-08-13", key: ["YAGNI/laziness-ladder lens during code review", "perf budget review during code review", "dead code + debt-marker harvest at sprint boundary"] } -->
