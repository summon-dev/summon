---
title: Summon
description: "Ship like a team of 10. You're the only human. Summon is a drop-in AI engineering team for Claude Code — 16 agents, 24 commands, real methodology."
template: splash
head:
  - tag: meta
    attrs:
...
<CardGrid>
  ...
  <Card title="24 Slash Commands" icon="terminal">
