...
> **The agent holds your shell.** The owner-harm lens (C1–C8) names the ways it can harm *you*, its operator, not just your users: `rm -rf` on real data, a leaked credential, an action nobody authorized.
